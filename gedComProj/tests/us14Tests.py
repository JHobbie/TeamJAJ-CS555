import unittest
import gedComProj.src.us14Story as us14Story

def suite():
    suite = unittest.TestLoader().loadTestsFromTestCase(us14TestCase)
    return suite
class us14TestCase(unittest.TestCase):
    def setUp(self):
        #i02
		...
		self.family = {'MARR': ['19 FEB 1990'], 'WIFE': ['I02'], 'CHIL': ['I03', 'I05', 'I06', 'I07', 'I08', 'I09', 'I10', 'I11', 'I12', 'I13', 'I14', 'I15', 'I16'], 'HUSB': ['I01'], 'type': 'FAM', 'ID': 'F01'}


		self.familyDict = {'F01': self.family}
		self.individualDict = {'I02' : self.mom, 'I01' : self.dad, 'I03' : self.child1, 'I05' : self.child2, 'I06' : self.child4, 'I07' : self.child3, 'I08' : self.child5, 'I09' : self.child6, 'I10' : self.child7, 'I11' : self.child8, 'I12' : self.child9, 'I13' : self.child10, 'I14' : self.child11, 'I15' : self.child12, 'I16' : self.child13}
    ...
    def test_us14(self):
        errmsg = us14Story.multipleBirths(self.individualDict, self.familyDict)
        self.assertEqual(2, len(errmsg), "Family has two sets of sextuplets.")
