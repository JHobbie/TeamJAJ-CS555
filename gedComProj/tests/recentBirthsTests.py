...
class recentBirthsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        #i03
        self.child1 = {'NAME': ['Candy /Kane/'],  'FAMS': ['F02'], 'BIRT': ['1 NOV 2019'], 'SEX': ['F'], 'type': 'INDI', 'ID': 'I03'}
        #i05
        self.child2 = {'NAME': ['Reese /Bar/'], 'BIRT': ['20 MAY 1994'], 'SEX': ['M'], 'type': 'INDI', 'ID': 'I05'}
        #i07
        self.child3 = {'NAME': ['Lemon /Drop/'],  'FAMS': ['F03'], 'BIRT': ['31 OCT 2019'], 'SEX': ['F'], 'type': 'INDI', 'ID': 'I07'}
        #i06
        self.child4 = {'NAME': ['Mars /Bar/'], 'BIRT': ['3 NOV 2019'], 'SEX': ['M'], 'type': 'INDI', 'ID': 'I06'}
